...
2. Forma reciente y tendencia (equipos que mejoran o caen).
3. Contexto: qué se juega cada equipo (ya clasificado, obligado, rotación).
4. Sede y clima (crítico para Solsticio).
